import { Button, type TipTapButtonProps } from './button'
...
export interface BlockquoteButtonProps extends Omit<TipTapButtonProps, 'type'> {
  /**
    ...
    return (
      <Button
        ...
        className={`${className.trim()} ${
          isActive ? 'bg-important hover:bg-important-hover active:bg-important-active text-background dark:text-foreground' : ''
        }`}
        disabled={isDisabled}
        data-style='ghost'
        ...
        {children || (
          <>
            <TextQuote className={isActive ? 'text-background dark:text-foreground' : ''} />
